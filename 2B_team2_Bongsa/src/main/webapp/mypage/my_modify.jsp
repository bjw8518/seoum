...
<script type="text/javascript" src="${pageContext.request.contextPath}/mypage/js/modifycheck.js"></script>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/sw_login.css?afte">
<style type="text/css">
.conw_96 {
	position: relative;
	width: 960px;
...
<body class="u-body u-xl-mode bg-light">
	...
	<div class="container-fluid bg-white navbar navbar-expand-lg w-100 border-bottom">
		<div class="Mcontainer conw_96" style="position:relative; right: 150px; top: 2px;">
	...
	<div class="container conw_96 f_13">
		<div class="container-fluid  f_13 ">
			<div class="container conw_96"">
				<div class="row">
					<div class="rounded border col-6 bg-white my-3 mx-auto p-3" style="height: fit-content;">
						<h4 class="mt-3 text-start">내 정보 수정</h4>
						<hr>
						<form action="my_modify.do" method="post" id="userJoin">
							<div class="mb-3 row">
								<div class="">아이디</div>
								<div class="">
							...
							<div class="mb-3 row">
								...
								<div class="">
									<div class="input-group mb-1 col">
										...
										<input type="text" class="form-control " id="domain-txt" disabled value="${fn:split(user.mem_email,'@')[1] }"> 
										<select class="form-select" id="domain-list" value="${fn:split(user.mem_email,'@')[1] }">
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
							...
							<c:set var="bday" value="${user.mem_bday }" />
							<div class="mb-3 row">
								<div class="">생년월일</div>
								<div class=" ">
									<div class="input-group  mb-1 col">
										<input type="text" class="form-control" id="user_by" placeholder="년" value="${fn:split(bday,'-')[0] }"> <input type="text" class="form-control " id="user_bm" placeholder="월" value="${fn:split(bday,'-')[1] }"> <input type="text" class="form-control " id="user_bd" placeholder="일" value="${fn:split(bday,'-')[2] }"> <input type="hidden" id="totalBday" name="mem_bday" value="">
										<div id="validationServerUsernameFeedback" class="invalid-feedback "></div>
									</div>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<div class="">
									<select name="mem_role" class="form-select " id="selectRole">
										<c:forEach items="${roleOptionList}" var="option">
