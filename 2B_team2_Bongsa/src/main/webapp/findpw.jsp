				...
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							...
							<form action="findpw.do" method="POST" class="" novalidate="">
								<div class="mb-3 row">
									<div class="">
										<input type="text" class="form-control" id="user_id"
											name="mem_id" placeholder="아이디"> <a href="findid.do"
											class="float-right">아이디 찾기 </a>
								...
								<div class="form-group m-0">
									<button type="submit" id="find_pw"
										class="btn btn-primary btn-block">비밀번호 찾기</button>
								</div>
								<div class="mt-4 text-center">
									가입되어 있지 않으신가요? <a href="join.do">회원가입</a>
								</div>
							</form>
						</div>
					</div>
