...
<body class="u-body bg-light u-xl-mode" data-lang="en">
	<!-- 헤더 -->
	<div class="container-fluid navbar navbar-expand-lg w-100 border-bottom bg-white" style="color: #000;">
		...
		<div class="container my-0">
			<div class="row">
				...
				<div class="col-9 bg-white rounded border my-3 flex-grow-1">
					<div class=" p-3">
						<h4 class="mt-3">승인된 신청</h4>
						<span>승인된 신청을 확인할수 있습니다. </span>
						<hr>
						<table class="table">
									...
									<c:otherwise>
										<c:forEach items="${applylist }" var="ap">
											<tr style="height: 42px;" class="align-middle">
												...
												<td class=""> <c:catch>
														<c:choose>
															<c:when test="${ap.ap_state eq '확정(승인)' }">
																<a href="" class="modalbtn" data-applyinfo="${ap.ap_id },${ap.ap_ptitle}, ${ap.ap_pdate},${pg.ap_ptime },${ap.ap_mname},${ap.ap_mrole},${ap.ap_state}" id="applyModalbtn" data-bs-toggle="modal" data-bs-target="#exampleModal">완료</a>
															</c:when>
															<c:otherwise>
																<a title="처리된 내역은 수정이 불가합니다.">완료</a>
															</c:otherwise>
														</c:choose>
													</c:catch></td>
											</tr>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="applicant_end.do" method="post" id="appli_form">
						...
						<div class="mb-3 row">
							<label for="mem_name" class="col-sm-3 col-form-label">봉사 날짜 / 시간</label>
							<div class="col-sm-8">
								<input type="text" readonly class="form-control-plaintext" id="ap_pdate" name="ap_pdate" value="">
							</div>
						</div>
						<div class="mb-3 row">
							<label for="mem_name" class="col-sm-3 col-form-label">봉사자 명</label>
							<div class="col-sm-8">
						...
						<div class="row justify-content-center">
							<div class="form-check col-4 m-3">
								<input class="form-check-input appli_ck" type="radio" id="confirm_ck" value="활동완료" name="state_val" checked> <label class="form-check-label" for="confirm_ck"> 활동완료 </label>
							</div>
							<div class="form-check col-4 m-3">
								<input class="form-check-input appli_ck" type="radio" id="rejec_ck" value="활동미완료" name="state_val"> <label class="form-check-label" for="rejec_ck">활동미완료</label>
							</div>
						</div>
