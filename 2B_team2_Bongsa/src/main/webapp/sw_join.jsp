						...
						<div class="card-body">
							...
							<form action="login.do" method="POST" class="my-login-validation" novalidate="">
								<div class="form-group">
									...
									<input id="user_id" type="text" class="form-control" name="mem_id" value="" required autofocus>
								...
								<div class="form-group">
									...
									<input id="password" type="password" class="form-control" name="mem_pw" required data-eye>
<!-- 								    <div class="invalid-feedback">
								...
								<div class="mt-4 text-center">
									처음이시라면? <a href="register.html">회원가입</a>
								</div>
							</form>
						</div>
					</div>
