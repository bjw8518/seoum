    ...
    <body>
            ...
            <div class="container px-lg-5">
                <div class="p-4 p-lg-5 bg-light rounded-3 text-center">
                    <div class="m-4 m-lg-5">
                        <h1 class="display-5 fw-bold">봉사제목DB</h1>
                    </div>
                </div>
            </div>
        </header>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered table-hover">
                                <tr>
                                    <th class="table-secondary">봉사기간</th>
                                    <td>DB</td>
                                    <th class="table-secondary">봉사시간</th>
                                    <td>DB</td>
                                </tr>
                                <tr>
                                    <th class="table-secondary">모집기간</th>
                                    <td>DB</td>
                                    <th class="table-secondary">활동요일</th>
                                    <td>DB</td>
                                </tr>
                                <tr>
                                    <th class="table-secondary">모집인원</th>
                                    <td>DB</td>
                                    <th class="table-secondary">신청인원</th>
                                    <td>DB</td>
                                </tr>
                                <tr>
                                    <th class="table-secondary">봉사분야</th>
                                    <td>DB</td>
                                    <th class="table-secondary">봉사자유형</th>
                                    <td>DB</td>
                                </tr>
                                <tr>
                                    <th class="table-secondary">모집기관</th>
                                    <td>DB</td>
                                    <th class="table-secondary">등록기관</th>
                                    <td>DB</td>
                                </tr>
                                <tr>
                                    <th class="table-secondary">봉사장소</th>
                                    <td>DB</td>
                                    <th class="table-secondary">봉사대상</th>
                                    <td>DB</td>
                                </tr>
                                <tr>
        ...
        // marker.setMap(null);    
            ...
            <div class="support_btn">
                <button type="button" class="support_button" onclick="location.href='#'">지원하기</button>
            </div>
            <!--버튼-->
        </section>
        <!-- Footer-->
